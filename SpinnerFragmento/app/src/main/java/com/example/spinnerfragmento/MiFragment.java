...
public class MiFragment extends Fragment {
    ...
    public static MiFragment newInstance(Persona persona){
        MiFragment fragment = new MiFragment();
        Bundle args = new Bundle();
        args.putSerializable(ARG_PARAM1, persona);
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        if (getArguments() != null){
            mParam1 = (Persona) getArguments().getSerializable(ARG_PARAM1);
        };
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        miFoto.setImageResource(mParam1.getFoto());
        return v;
    }
